...
public class DentistController extends AuthenticateController {
    ...
    public ModelAndView edit_get(@PathVariable Long dentistID, HttpSession session) {
        ...
        try {
            ...
            return new ModelAndView("dentist/index", "message", new Message(Message.SUCCESS, "Dentist with ID " + dentistID + " is found!"));
        }
    }
    ...
    public ModelAndView delete_get(@PathVariable Long dentistID, HttpSession session) {
        ...
        try {
            ...
            return new ModelAndView("dentist/index", "message", new Message(Message.ERROR, "Dentist was not update, try again later!"));
        }
    }
